  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <p className="text-[13px] text-[#71717a]">Gateway performance overview</p>
      ...
      {/* Main chart */}
      <div className="border border-[#1a1a1f] rounded-xl mb-6 overflow-hidden">
          ...
          <div className="flex gap-0">
            {[
              ...
              <button
                ...
                className={`px-4 h-12 text-[12px] font-medium border-b-2 transition-colors -mb-px ${
                  activeTab === tab.key
      ...
      <div className="grid grid-cols-5 gap-4">
        {/* Method Calls — 3 cols */}
        <div className="col-span-3 border border-[#1a1a1f] rounded-xl overflow-hidden">
          <div className="px-5 h-12 flex items-center border-b border-[#1a1a1f]">
            <h3 className="text-[12px] font-medium text-[#a1a1aa]">Method Calls</h3>
        ...
        <div className="col-span-2 border border-[#1a1a1f] rounded-xl overflow-hidden">
          <div className="px-5 h-12 flex items-center border-b border-[#1a1a1f]">
            <h3 className="text-[12px] font-medium text-[#a1a1aa]">By Network</h3>
          </div>
          <div className="p-5">
            {networks.length === 0 ? (
